...
function selectRadioBtn(){
  ...
  for (let i = 0; i < radio1.length; i++) {  // F

    if (radio1[i].checked) {  // G + H
  ...
  window.alert("1つ選択（select）してください");  // L
}

//localStorage からのテーブルの取得とテーブルへ表示
