...
const stopSound = new Audio("sound/stop1.mp3");
const winSound = new Audio("sound/stop2.mp3");
...
stop.addEventListener("click",
  function () {
    ...
    if (seconds >= 10.00 && seconds < 11.00) {
      winSound.currentTime = 0;
      winSound.play();
      document.querySelector(".wrapper").classList.add("fireworks-bg");
    }
...
reset.addEventListener("click",
  function () {
    ...
    stopTime = 0;
    document.querySelector(".wrapper").classList.remove("fireworks-bg");
